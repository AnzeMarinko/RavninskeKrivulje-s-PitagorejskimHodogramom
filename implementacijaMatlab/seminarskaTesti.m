...
% konstanten \Delta s
b = bezier(B1,naravnaParametrizacijaPH(N,u1,v1,20));
plot(b(1,:),b(2,:),'.')
...
tan1 = tangentaPH(u1,v1,t1)*parSpeedPH(u,v,t1)/5;
plot([p1(1) (p1(1)+tan1(1))],[p1(2) (p1(2)+tan1(2))])
tan2 = tangentaPH(u1,v1,t2)*parSpeedPH(u,v,t2)/5;
...
ukrivljenostPH(u,v,t1);
ukrivljenostPH(u,v,t2);

% izris razlicnih odmikov od iste krivulje
plotrodmikPH(u1,v1,x0,y0,t,0.1:0.1:0.5)
